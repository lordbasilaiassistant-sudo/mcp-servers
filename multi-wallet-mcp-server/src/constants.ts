/**
 * Chain configurations and well-known token addresses.
 * ERC20_ABI is re-exported from @thryx/mcp-shared to avoid duplication.
 */

export { ERC20_ABI } from "@thryx/mcp-shared";
